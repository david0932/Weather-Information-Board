...
function make_image($text){
		...
		imagettftext($image, 16, 0, 0, 18,$black, $font, $text);
		// put to png file
...
$weather_text = array('雷雨'=>'thunderstorm rain' ,'驟雨'=>'showers rain','小驟雨'=>'light showers rain','多雲'=>'Cloudy','小雪' => 'Flurries','霧' => 'Fog','陰霾' => 'Haze','多雲時陰' => 'Mostly Cloudy','晴時多雲' => 'Mostly Sunny','局部多雲' => 'Partly Cloudy','多雲時晴' => 'Partly Sunny','凍雨' => 'Freezing Rain','雨' => 'Rain','冰雹' => 'Sleet','雪' => 'Snow',
'晴朗' => 'Sunny','未知' => 'Unknown','陰天' => 'Overcast','疏雲' => 'Scattered Clouds',
'小雨' => 'light rain', "小雨薄霧" => 'light rain mist',"雨霧" => "rain mist","薄霧" => "mist","晴朗" => "Clear",'陰霾' => 'haze','雷暴雨' => 'Thunderstorm','驟雨薄霧' => 'Showers Rain Mist','雷驟雨' => 'thunderstorm showers rain', '小驟雨' => 'light showers rain','陰天' => 'overcast','驟雨薄霧' => 'showers rain mist');
  					 
// ?query=[觀測點名稱]，例如: Taoyuan Air Base , Taipei 
$city = $_GET['city'];
$weather = $_GET['weather'];
$geo = $_GET['geo'];
if (isset($geo) && isset($weather) && isset($city)){
