...
// 天氣狀態
/*
$weather = array( "thunderstorm rain", "showers rain", "light showers rain",
				  "Cloudy","Flurries","Fog","Haze",
				  "Mostly Cloudy","Mostly Sunny","Partly Cloudy",
				  "Partly Sunny","Freezing Rain","Rain",
				  "Sleet","Snow","Sunny",
				  "Unknown","Overcast","Scattered Clouds");
$weather_text= array("雷雨","驟雨","小驟雨",		
					 "多雲","小雪","霧","陰霾",
					 "多雲時陰","晴時多雲","局部多雲",
					 "多雲時晴","凍雨","雨",
					 "冰雹","雪","晴朗",
